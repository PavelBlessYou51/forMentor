package selenide_tests.tests.industrial_sample;
...
@DisplayName("Класс с тестами направления запросов гос органов и нац ведомств по ПО")
@ExtendWith(BrowserPerTestStrategyExtension.class)
public class SendGovRequestByIndTests extends TestSelenideBase {
    ...
    public void sendGovernmentRequestTest() {
        String appNumber = app.jdbc().getInventionApp(14157, 'D');
        app.login().login(ConfigProvider.getUserLogin(), ConfigProvider.getUserPassword());
        app.login().selectSectionOfAccount("industrial");
